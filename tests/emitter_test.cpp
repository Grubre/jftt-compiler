...
TEST_CASE("Slowik tests") {
    std::array test_params = {
        TestParams<cln::cl_I>{"/slowik/test0.imp", {}, {cln::cl_I("340282367713220089251654026161790386200"), cln::cl_I("340282367713220089251654026161790386200")}},
